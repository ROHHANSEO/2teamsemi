...
/**
 * Servlet implementation class UsedItemsListPriceDesc
 */
@WebServlet("/usedListPriceDesc.do")
public class UsedItemsListPriceDescServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public UsedItemsListPriceDescServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		ArrayList<UsedItemsBoard> list = new UsedItemsBoardService().selecPriceDescList(pi);
		...
		request.getRequestDispatcher("views/used_item_board/usedItemsPriceDescList.jsp").forward(request, response);
	}
