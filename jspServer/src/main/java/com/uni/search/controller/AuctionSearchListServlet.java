...
/**
 * Servlet implementation class AuctionSearchListServlet
 */
@WebServlet("/auctionSearchList.do")
public class AuctionSearchListServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public AuctionSearchListServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		ArrayList<Auction> aList = new AuctionService().searchAuctionList(search, pi);
		...
		if(!aList.isEmpty()) {
			...
			request.getRequestDispatcher("views/search/searchAuctionList.jsp").forward(request, response);
		}else {
