...
/**
 * Servlet implementation class AuctionLikeDescSearchServlet
 */
@WebServlet("/auctionSearchListLikeDesc.do")
public class AuctionLikeDescSearchServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public AuctionLikeDescSearchServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		ArrayList<Auction> aList = new AuctionService().searchAuctionLikeDescList(search, pi);
		...
		if(!aList.isEmpty()) {
			...
			request.getRequestDispatcher("views/search/searchAuctionLikeDescList.jsp").forward(request, response);
		}else {
