...
/**
 * Servlet implementation class popAuctionServlet
 */
@WebServlet("/popAutcion.do")
public class popAuctionServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public popAuctionServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		ArrayList<Auction> aulist = new AuctionService().selectPopList(pi);
		...
		request.getRequestDispatcher("views/auction/popAuctionListView.jsp").forward(request, response);
