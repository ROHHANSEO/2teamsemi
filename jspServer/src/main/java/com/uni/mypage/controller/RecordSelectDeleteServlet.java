...
/**
 * Servlet implementation class RecordSelectDeleteServlet
 */
@WebServlet("/selectDelete")
public class RecordSelectDeleteServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public RecordSelectDeleteServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		int result = new MyPageService().selectDelete(bnoArr);
