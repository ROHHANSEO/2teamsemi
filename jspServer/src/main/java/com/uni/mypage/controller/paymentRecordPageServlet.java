...
/**
 * Servlet implementation class paymentRecordPageServlet
 */
@WebServlet("/paymentRecordPage")
public class paymentRecordPageServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public paymentRecordPageServlet() {
        super();
